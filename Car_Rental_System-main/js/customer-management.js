document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadCustomers(search = '', sort = 'id') {
        try {
            const url = `../php/customer-management.php?page=${currentPage}&items_per_page=${itemsPerPage}&search=${search}&sort=${sort}`;
    ...
    async function showEditModal(customerId) {
        try {
            const response = await fetch(`../php/get-customer-details.php?id=${customerId}`);
    ...
    async function handleDelete(customerId) {
        ...
        try {
            ...
            const response = await fetch('../php/customer-management-delete.php', {
                method: 'POST',
                headers: {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('../php/update-customer.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async function updateLicenseStatus(customerId, status) {
        try {
            const response = await fetch('../php/update-license-status.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
